...
const AboutPage: React.FC = () => {
  ...
  return (
    <div id="about" className="flex flex-col items-center justify-center">
      <div className="flex h-screen flex-col items-center p-4 pb-[50px] md:justify-between md:px-16">
        ...
        <div className=" flex flex-col items-center justify-between">
          ...
          <div className="mt-24 flex h-[300px] w-[90%] flex-col gap-8 md:flex-row md:gap-24">
